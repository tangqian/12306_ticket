/*
 * 12306-ticket: Java Swing C/S版本12306订票助手
 ...
 */
public class TicketMainFrameBak extends JFrame {

    private static final long serialVersionUID = -6541864654653129335L;

    private static final Logger logger = LoggerFactory.getLogger(TicketMainFrameBak.class);

    private static final DateFormat df = new SimpleDateFormat("HH:mm:ss.SSS");

    private static TicketMainFrameBak frame;
